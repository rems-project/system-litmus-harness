 ...
 * etc
 */
#define STACK_MMAP_THREAD_TOP_EL0(cpu) (STACK_MMAP_BASE + (1+(cpu))*3*STACK_SIZE - 2*STACK_SIZE)
#define STACK_MMAP_THREAD_TOP_EL1(cpu) (STACK_MMAP_BASE + (1+(cpu))*3*STACK_SIZE - STACK_SIZE)
#define STACK_MMAP_THREAD_TOP_EL2(cpu) (STACK_MMAP_BASE + (1+(cpu))*3*STACK_SIZE)
...
#define STACK_MMAP_THREAD_BOT_EL2(cpu) (STACK_MMAP_THREAD_TOP_EL2(cpu) - STACK_SIZE)
