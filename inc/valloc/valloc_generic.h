...
#define ALLOC_SIZE(p) (valloc_alloclist_find_alloc_chunk(&mem, (u64)(p))->size)
...
#define ALLOC_MANY(ty, count) __ALLOC_MANY(FRESH_VAR, ty, count)
...
#define ALLOC_SIZED(size) __ALLOC_SIZED(FRESH_VAR, size)
