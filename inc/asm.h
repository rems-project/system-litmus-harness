...
#define SCTLR_HI                                                                                              \
  ((SCTLR_NOTRAP_CACHE_MAINTENANCE | SCTLR_LITTLE_ENDIAN | SCTLR_NOPAN | SCTLR_EXCEPTION_ISB | SCTLR_NOIESB | \
    SCTLR_NOWXR | SCTLR_NOTRAP_WFE | SCTLR_NOTRAP_WFI | SCTLR_NOTRAP_DCZ | SCTLR_NOTRAP_CTR | SCTLR_I) >>     \
   12)
