...
litmus_test_t BBM1_podsbtlbiisdsbisbdsbisb_dsbisb = {
  "MP.BBM1+po-dsb-tlbiis-dsb-isb-dsb-isb+dsb-isb",
  MAKE_THREADS(2),
  MAKE_VARS(VARS),
  MAKE_REGS(REGS),
  INIT_STATE(4, INIT_VAR(x, 0), INIT_VAR(y, 0), INIT_VAR(a, 1), INIT_VAR(z, 1)),
